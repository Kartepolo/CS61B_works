...
public class WordNetDemo {
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println(wn3.isNoun("hood"));
        System.out.println("Testing whole dataset:");
        System.out.println("Hypnoyms of operation:");
        for (String noun : wn3.hyponyms("operation")) {
            System.out.println(noun);
        }
    }    
} 
